...
def run(input_path, output_path, overwrite=False, dry_run=False):
    ...
    output_root = resolve_output_root(input_path, output_path)
    input_root = (
...
def main():
    ...
    return run(args.input, args.output, args.overwrite, args.dry_run)
