...
st.set_page_config(page_title="Visualization of all DOHA ISCR Hearing Decisions in 2025", layout="wide")

st.title("Visualization of all DOHA ISCR Hearing Decisions in 2025")

# Load Data
DATA_FILE = "classified_cases.csv"
